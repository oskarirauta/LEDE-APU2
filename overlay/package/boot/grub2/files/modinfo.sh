...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (OpenWrt GCC 5.4.0) 5.4.0'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-openwrt-linux-musl/5.4.0/include -I$(top_srcdir)/include -I$(top_builddir)/include'
grub_target_ccasflags=' -g  -m32 -msoft-float'
grub_target_ldflags=' -m32 -Wl,-melf_i386 -Wl,--build-id=none'
grub_cflags='-Os -pipe -march=btver2 -mtune=btver2'
grub_cppflags=' -D_FILE_OFFSET_BITS=64'
grub_ccasflags='-Os -pipe -march=btver2 -mtune=btver2'
grub_ldflags=''
